...
map_marker.forEach(item=>{
   ...
   item.addEventListener('mouseover',()=>{
      ...
      let left=parseInt(result.getPropertyValue('left'))+30;
      item.style.left=left+"px";
      let top=parseInt(result.getPropertyValue('top'))+30;
      ...
      let left2=parseInt(result.getPropertyValue('left'));
